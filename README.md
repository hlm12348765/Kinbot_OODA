...
- 主线已完成 `Phase 1-4.5` 的架构侧收口，并正式进入 `Phase 5：验证口径与治理闭环`。
- `Phase 5` 当前只完成架构侧验证规划、双泳道门控和证据结构预留，尚未进入真实实机 / 市场闭环。
- `P1` 主线事实源已收敛为：原则层 -> 总体架构 -> 运行时基线 -> 合同 / 专题层 -> `P2` 下发基线。
- `docs/08_reviews/` 当前只保留少量活跃评审入口；历史评审稿与旧阶段收口稿已迁入 `archive/`。
...
6. [docs/03_p2_feasibility/01_overall_solution_and_module_design_baseline.md](docs/03_p2_feasibility/01_overall_solution_and_module_design_baseline.md)：总体方案与模块方案下发基线。
7. [docs/08_reviews/README.md](docs/08_reviews/README.md)：活跃评审入口。
8. [docs/05_p4_beta_dvt/01_mvp_validation_plan.md](docs/05_p4_beta_dvt/01_mvp_validation_plan.md)：`Phase 5` 工程/战略双泳道验证入口。
9. [docs/06_p5_launch_readiness/01_mass_production_readiness_criteria.md](docs/06_p5_launch_readiness/01_mass_production_readiness_criteria.md)：`G5` 门控与第 `8` 类战略证据包标准。
...
- 当前真实实机 / 市场闭环尚未发生，后续真实收口由 `KBT-55` 承接。
...
6. [docs/03_p2_feasibility/01_overall_solution_and_module_design_baseline.md](docs/03_p2_feasibility/01_overall_solution_and_module_design_baseline.md)
7. [docs/08_reviews/README.md](docs/08_reviews/README.md) -> [docs/08_reviews/21_seven_entity_world_state_target_model.md](docs/08_reviews/21_seven_entity_world_state_target_model.md) -> [docs/08_reviews/25_phase3_to_phase45_closure_and_strategic_input_package.md](docs/08_reviews/25_phase3_to_phase45_closure_and_strategic_input_package.md) -> [docs/08_reviews/24_kbt52_strategic_ambition_gap_review.md](docs/08_reviews/24_kbt52_strategic_ambition_gap_review.md)
8. [docs/05_p4_beta_dvt/01_mvp_validation_plan.md](docs/05_p4_beta_dvt/01_mvp_validation_plan.md)
9. [docs/06_p5_launch_readiness/01_mass_production_readiness_criteria.md](docs/06_p5_launch_readiness/01_mass_production_readiness_criteria.md)
10. [docs/00_governance/03_decision_log.md](docs/00_governance/03_decision_log.md)
11. [docs/00_governance/01_workflow.md](docs/00_governance/01_workflow.md)

## 历史资料与工作文档

- [docs/08_reviews/archive/README.md](docs/08_reviews/archive/README.md)：历史评审、旧阶段收口稿与革新决策链归档入口。
...
- `docs/02_p1_architecture/`：系统架构主线、运行时、接口与合同层。
