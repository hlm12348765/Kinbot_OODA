...
| ID | 问题 | 为什么关键 | 状态 |
| --- | --- | --- | --- |
| Q-001 | 陪伴交互中的记忆修改、删除、纠错和用户可见性如何设计 | 决定记忆治理、用户信任和 App 产品边界 | open |
| Q-002 | 老人本人、子女、保姆对陪伴记忆、纪念日、提醒和人设调节的配置权限如何划分 | 决定多角色产品策略和授权模型细化 | open |
| Q-003 | 厨房、卧室、卫生间、入户门、阳台等空间是否需要一代就建立差异化安全等级和交互规则 | 决定空间模型、风险策略和主动交互限制 | open |
| Q-004 | 陌生人闯入、门窗未关、夜间离床等安全事件在一代是否允许主动通知家属或触发设备联动 | 决定安全升级链和伴生系统接口优先级 | open |
| Q-005 | 低电量、定位异常、关键传感器失效时的“继续执行 / 挂起 / 中止 / 请求人工”阈值如何量化 | 决定功能安全状态机和验证标准 | open |
| Q-006 | 家属 App、云服务和后台运营坐席在一代最小闭环里各自必须承接哪些能力 | 决定伴生系统 MVP 范围和整机闭环完整度 | open |

## 5. 下一轮优先向用户确认的问题

建议下一轮优先把陪伴交互治理、安全空间规则和伴生系统闭环补齐：

1. 用户是否需要在 App 中查看、修改、删除机器人对“纪念日 / 偏好 / 家庭事件 / 健康历史”的长期记忆？哪些记忆必须允许人工纠错？
2. 老人本人、子女、保姆三类角色，分别能否配置纪念日、提醒、主动交互频率和人设强度？冲突时谁优先？
3. 厨房、卫生间、卧室、入户门、阳台这 5 类空间，一代是否需要差异化安全等级和交互规则？哪些空间夜间必须更保守？
4. 对陌生人闯入、夜间离床、门窗未关这三类事件，一代分别允许哪些自动动作：主动靠近、主动询问、通知家属、联动智能家居、请求人工坐席？
5. 低电量、定位异常、关键传感器失效时，你希望系统更保守还是更积极恢复？哪些情况下必须立即中止运动？
6. 家属 App、云服务、后台运营坐席这三类伴生系统里，一代最小闭环必须各自承接哪些能力？
