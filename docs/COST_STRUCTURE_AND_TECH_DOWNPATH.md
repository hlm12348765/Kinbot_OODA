...
- 机器人整机与服务组合还必须让用户感受到它是“聪明、温暖、精致”的，并且能够支撑约 `30000 元` 价格带的产品认知。

因此当前把 6 条护栏固定下来：

1. 不能为了压 `C3 / C6`，把前脸、屏幕、灯光和交互表达做成廉价 IoT 感。
2. 不能为了压 `C4`，把运动体验做得迟钝、噪声大、过门槛差或明显缺乏从容感。
3. 不能为了压 `C1 / C2`，让机器人在找人、识人、导航、理解指令时表现出明显“笨”的感觉。
4. 不能把关键陪伴体验过度外包给手机 App，否则温暖感和陪伴感会被削弱。
5. 结构、声学、屏幕、灯光、语音、动作要作为一个整体组合评估，而不是各桶局部最优。
6. 任何显著降本动作，都要同时回答“是否还撑得住高端产品感知”。
...
6. 自本轮起，每次显著降本方案评审都要附带一页“高端产品感知检查表”，判断是否还能支撑约 `30000 元` 价格带。
