...
结合现有 [docs/02_p1_architecture/01_overall_architecture.md](../02_p1_architecture/01_overall_architecture.md) 与 [docs/02_p1_architecture/04_module_layers_and_boundaries.md](../02_p1_architecture/04_module_layers_and_boundaries.md)，建议把 VLN 放在如下位置。
