...
文档变更记录：
- v1.1 | 2026-04-12 | Codex-架构师 | 从 `docs/03_p2_feasibility/` 迁入 `docs/09_research/`，明确本文作为夜间闭环研究输入，不再冒充 `P2` 正式冻结文档。
- v1.0 | 2026-03-09 | GPT5.4Pro-工程专家 | 文档创建。

---

## 0. 文档定位补充

本文当前位于 `docs/09_research/`，角色是**研究输入**：

1. 用于沉淀夜间纯视觉闭环的系统工程路线与数据闭环设想；
2. 不直接替代 `P2` 总体方案、审批边界或量产冻结结论；
3. 若其中结论后续影响主线，应再由当前线程回写到正式架构或方案文档。
