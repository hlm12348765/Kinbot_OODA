...
> 本文件保留 2026-07-20 拆分前的完整规则，用于迁移核对和追溯。
> 它不是默认工作入口；当前规则以各级 `AGENTS.md` 和根级路由为准。
...
文档变更记录：
- v1.64 | 2026-07-20 | Codex-架构师 | 固化 L0 收口状态：16 号文档第 3、4 章的系统形式与功能、信息 / 物理过程及操作数关系已获用户确认；过程到 `F1 + A1-A8` 的精确责任分配和 L1 架构仍由 `KBT-59` 评审。
...
- `16` 号文档第 3、4 章的 L0 系统边界、形式与功能，以及 `I1～I8 / I-P1～I-P8 / P1～P6 / P-P1～P-P7` 的过程—操作数关系已经用户确认；纸面枚举、连线和领域聚类可独立回归到 `OODA + Feedback + Management`。该确认不包含过程到 `F1 + A1-A8` 的精确责任分配
