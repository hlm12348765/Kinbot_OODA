...
1. **检查 `input/00_user_requirements_input.md` 顶部"对 Codex 的要求"** 是否有更新
...
- `input/00_user_requirements_input.md` 由用户独占维护，**不得修改**
...
1. `input/00_user_requirements_input.md` - 产品需求、边界和工程约束（用户独占维护）
