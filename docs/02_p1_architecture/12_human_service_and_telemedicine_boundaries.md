...
5. 这些服务链如何与共享状态平面、离散业务状态面、审批接口和健康事件管线对齐
...
- 后台人工服务能力必须预留，但覆盖范围、可用时段和组织方式按可收缩架构设计
- 后台人工服务首线角色为公司客服运营坐席
...
- 当前总架构已升级为“家庭共居智能体 + 多执行范式”，因此人工服务与在线问诊属于分布式家庭责任接力链，不替代本体端的第一责任闭环
...
1. 人工服务链可以接住离散决策失败、事件驱动升级、长周期策略异常和家属主动求助。
2. 人工服务链接手的是服务协同与专业分诊，不是把本体执行权整体外包。
3. 一旦人工或第三方请求落到机器人本体动作，仍必须回到统一审批门和本体安全链。
...
`KBT-13` 当前冻结的是“一代必须预留首线人工服务能力”，不是冻结其唯一组织实现方式，也不是冻结默认高覆盖运营形态。
...
1. 与 [docs/02_p1_architecture/11_app_cloud_ops_minimal_loop.md](11_app_cloud_ops_minimal_loop.md) 的关系：后者定义伴生系统闭环，本文定义其中“人工服务与在线问诊”的专业边界
2. 与 [docs/02_p1_architecture/10_health_event_pipeline_and_escalation.md](10_health_event_pipeline_and_escalation.md) 的关系：后者定义事件主线，本文定义事件升级后的人类与第三方协同链
3. 与 [docs/02_p1_architecture/07_safety_compliance_authorization_api.md](07_safety_compliance_authorization_api.md) 的关系：人工与第三方接入不能绕过统一审批门
4. 与 [docs/02_p1_architecture/05_world_state_schema.md](05_world_state_schema.md) 的关系：`manual_service_state`、`care_network`、`service_link` 等状态字段要承接本文的角色和会话边界
