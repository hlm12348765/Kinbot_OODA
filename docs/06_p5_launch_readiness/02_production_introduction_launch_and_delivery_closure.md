...
1. 与 [docs/06_p5_launch_readiness/01_mass_production_readiness_criteria.md](01_mass_production_readiness_criteria.md) 的关系：后者定义 `G5` 判定门，本文定义 `P5` 如何把判定门变成发布与交付闭环。
2. 与 [docs/05_p4_beta_dvt/01_mvp_validation_plan.md](../05_p4_beta_dvt/01_mvp_validation_plan.md) 的关系：后者定义试点验证什么，本文定义试点之后如何收口并承接交付。
3. 与 [docs/03_p2_feasibility/03_engineering_npi_baseline.md](../03_p2_feasibility/03_engineering_npi_baseline.md) 的关系：后者定义工程化输入，本文定义量产导入前的组织和交付准备。
4. 与 [docs/02_p1_architecture/12_human_service_and_telemedicine_boundaries.md](../02_p1_architecture/12_human_service_and_telemedicine_boundaries.md) 的关系：后者定义角色边界，本文定义首批交付时这些角色如何被运营体系真正接住。
