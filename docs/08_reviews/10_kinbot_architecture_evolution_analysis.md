...
3. 阶段 3 的关键任务，不是推翻当前主线，而是在一代周期内把当前主线进一步演化成“更强的运行时架构”。
4. 阶段 4 的关键任务，是承认一代不会直接到终局，因此必须为“关系中心、经验学习、家庭元场景泛化”预留未来演进方向。
...
这一阶段不建议重开 `PDCP` 主线，而应按“三线吸收法”演进：
...
一代期内，Kinbot 架构应从“静态冻结基线”演进为“动态强化基线”，重点做 5 类演进。
...
这一阶段应更多参考 [架构师综合评审与计划](./01_architect_review_and_plan.md) 和 [关系中心架构提案](./08_relation_centered_architecture_proposal.md)。
