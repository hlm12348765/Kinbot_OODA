...
- `01_mvp_validation_plan.md` §4.1 战略验证泳道的"远程在场感"一问，其结构性前提是机群能力清单中至少有一个接入点能够支撑"跨地点的家人感知"；
- 本节不要求 `Phase 5` 立即激活任何接入点，但要求 `Phase 5` 在设计验证项时**显式回答**："如果这些接入点全部留作占位，远程在场感能否被验证？"
