...
| 层级 | 代表产品 | 已证明的能力 | 当前主要缺口 |
| --- | --- | --- | --- |
| 直接产品竞品 | Ballie、Astro、EBO X、temi、小丽、大头阿亮、达闼、猎户 | 移动陪伴、看护、平台服务可做 | 强语义移动、长期家庭记忆、高端家庭闭环不足 |
| 前瞻技术与叙事竞品 | 1X、Figure、Optimus、Walker、小米人形、GR-3 | 终局想象力、技术声量强 | 价格带、交付节奏、家庭产品化现实性不足 |

### 5.3 竞品结论

| 结论维度 | 当前判断 | 对 EMT 的含义 |
| --- | --- | --- |
| 短期同构竞争 | 同价格带、同形态、同系统完整度下缺少完全同构对手 | 可以先抢产品化高地 |
| 中期叙事竞争 | 家庭类人形路线会持续施压 | 需要提前建立非人形也成立的心智 |
| 当前最难回答的问题 | 为什么它比移动机器人更强、又为什么虽然不是人形仍然值得先买 | 这是概念评审必须说透的核心 |
