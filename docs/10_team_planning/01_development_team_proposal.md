...
文档变更记录：
- v1.3 | 2026-07-16 | Codex-架构师 | 将运动控制招聘从 MCU 嵌入式主轴调整为 SoC 侧算法主轴，明确经典控制先落地、深度强化学习渐进演进，MCU 继续承担硬实时执行和底层安全保护。
...
5. 运动控制招聘从“MCU 嵌入式控制底座 owner”调整为“SoC 运动控制算法 owner”：当前以状态估计和经典控制稳定交付为主，逐步建设模仿学习 / 深度强化学习能力；MCU 继续承担电机硬实时闭环、执行器驱动和底层安全保护。
