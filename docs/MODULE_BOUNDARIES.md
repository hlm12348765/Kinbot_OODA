...
1. `World State Schema`：把空间、人、任务、风险、权限、健康基线结构化
2. 决策状态机：把巡逻、陪伴、待机、回充、异常处理、上报等模式明确下来
3. `Safety / Compliance / Authorization API`：把动作审批、拒绝原因、升级路径固定下来
