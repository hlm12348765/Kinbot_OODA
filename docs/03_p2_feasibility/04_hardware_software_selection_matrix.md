...
- 本轮文档路径与标题口径统一采用 `docs/00_governance/00_requirements.md`、`docs/09_research/01_vln_role_analysis_and_technical_plan.md`、`docs/09_research/02_uwb_phase1_maturity_and_integration_value.md`。
