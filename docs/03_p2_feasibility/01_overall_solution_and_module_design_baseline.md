...
6. 一代纯视觉传感器主线已经进入系统架构基线：量产主线采用“双目 + 单目 `3 到 5` 个相机 + 自研深度估计 + 多目几何融合”，深度相机 / 激光雷达仅允许作为研发对比基线与真值参考链路
...
6. 深度相机 / 激光雷达作为研发对比基线与真值参考链路时的接口与验证方案
7. 若纯视觉不过线，如何触发“调整产品节奏”而不是回退主动传感主线
8. `D1 / D6` 在本体平台层的收敛路径、主备线和冻结门
...
7. 在严格 `BOM` 约束下，一代健康感知的“必须有 / 应该有 / 可以有”再次切分
...
7. 如何在更低 `BOM` 下保住“聪明、温暖、精致”的陪伴体验
