...
11. 如何从验证平台的 `50kg`、多执行器和高冗余传感，收敛到一代可量产的重量、自由度与器件数量
...
9. 如何复用验证平台中的高位双目主观测经验，同时重新论证低位地面视觉与长焦是否真的进入一代健康与安全闭环
...
9. 如何从验证平台“双麦阵修补遮挡与反射问题”的反例出发，完成头部视觉 / 屏幕 / 声学 / 结构一体化收敛，而不是继续叠加器件
