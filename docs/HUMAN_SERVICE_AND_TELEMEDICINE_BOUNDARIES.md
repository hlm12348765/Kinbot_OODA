...
以下 4 点目前作为 `KBT-13` 的正式评审入口：

1. 是否接受“机器人本地服务 -> 客服运营坐席 -> 医疗专业主体 / 第三方履约”的 4 层接力结构
2. 是否接受“音频优先、默认不启视频”的一代媒体策略
3. 是否接受当前的角色责任切分，特别是客服不做诊断、医生平台负责专业结论、平台负责履约结果
4. 是否接受当前的接入时效基线，尤其是“客服 `3 分钟` 响应、医疗专业主体 `10 分钟` 内给出接单结果”这一提案
